                    ...
                    <tbody>
                        ...
                        if (count($result) != 0) {
                            ...
                            foreach ($result as $value) {
                                $permission;
                                switch ($value['QuyenHan']) {
                                    case 1:
                                        $permission = "QTV";
                                        break;
                                    case 2:
                                        $permission = "Người viết tin";
                                        break;
                                    default:
                                        $permission = "Độc giả";
                                }
                                ...
                                echo '<tr>
                                    ...
                                    <td>' . $permission . '</td>
                                    <td>' . ($value['Khoa'] == 1 ? "Bị khóa" : "Hoạt động") . '</td>
                                    ...
                                    <td class="text-center">
                                        <a
                                            ...
                                            class="btn-delete"
                                            data-id="' . $value['ID'] . '"
                                            data-name="' . htmlspecialchars($value['TenDangNhap']) . '"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Bạn có chắc chắn muốn xóa người dùng <b id="deleteName"></b> không?
                </div>
