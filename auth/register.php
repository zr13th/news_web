    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center">
            <div class="card mt-5 col col-5">
                ...
                <div class="card-body">
                    <form action="register_handle.php" method="post" class="needs-validation" novalidate>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary w-100"><i class="bi bi-person-fill-add"></i> Đăng ký</button>
                    </form>
                </div>
            </div>
        </div>
